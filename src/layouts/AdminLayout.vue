    ...
    >
        ...
        <nav class="flex-1 space-y-2">
            <router-link
              ...
              :key="item.name"
              :to="item.route"
              class="flex items-center px-4 py-3 rounded-2xl font-semibold transition-all duration-300 ease-in-out group cursor-pointer overflow-hidden whitespace-nowrap"
              :class="[
                route.path === item.route 
                  ? 'bg-gradient-to-r from-[#143d2e] via-[#1b4d3a] to-[#256a50] text-white shadow-lg shadow-green-900/20 font-bold' 
                  : 'text-gray-700 hover:text-[#143d2e] hover:bg-gray-200/50'
              ]"
